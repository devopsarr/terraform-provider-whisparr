...
func TestAccDelayProfileResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccTagResourceConfig("test", "delay_profile_resource") + testAccDelayProfileResourceConfig("usenet", "whisparr_tag.test.id"),
			...
			{
				Config: testAccTagResourceConfig("test", "delay_profile_resource") + testAccDelayProfileResourceConfig("torrent", "whisparr_tag.test.id"),
				Check: resource.ComposeAggregateTestCheckFunc(
