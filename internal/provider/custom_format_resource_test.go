		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("whisparr_custom_format.test", "include_custom_format_when_renaming", "false"),
					resource.TestCheckResourceAttrSet("whisparr_custom_format.test", "id"),
				),
			},
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("whisparr_custom_format.test", "include_custom_format_when_renaming", "true"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "whisparr_custom_format.test",
				ImportState:       true,
