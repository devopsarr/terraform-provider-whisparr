...
func (c *CustomFormatCondition) write(ctx context.Context, spec *whisparr.CustomFormatSpecificationSchema) {
...
func (c *CustomFormatCondition) read(ctx context.Context) *whisparr.CustomFormatSpecificationSchema {
