...
func (s *CustomFormatCondition) write(spec *whisparr.CustomFormatSpecificationSchema) {
...
func (s *CustomFormatCondition) writeFields(fields []*whisparr.Field) {
...
func (s *CustomFormatCondition) read() *whisparr.CustomFormatSpecificationSchema {
...
func (s *CustomFormatCondition) readFields() []*whisparr.Field {
