...
func (d *QualityDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (q *Quality) find(name string, definitions []*whisparr.QualityDefinitionResource, diags *diag.Diagnostics) {
...
func (q *Quality) writeFromDefinition(quality *whisparr.QualityDefinitionResource) {
