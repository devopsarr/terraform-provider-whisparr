		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("whisparr_media_management.test", "file_date", "none"),
					resource.TestCheckResourceAttrSet("whisparr_media_management.test", "id"),
				),
			},
			// Unauthorized Read
			{
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("whisparr_media_management.test", "file_date", "cinemas"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "whisparr_media_management.test",
				ImportState:       true,
...
func testAccMediaManagementResourceConfig(date string) string {
	return fmt.Sprintf(`
	resource "whisparr_media_management" "test" {
