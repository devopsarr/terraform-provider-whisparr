...
page_title: "whisparr_media_management Data Source - terraform-provider-whisparr"
subcategory: "Media Management"
description: |-
  Media Management ../resources/media_management.
---

# whisparr_media_management (Data Source)
...
```terraform
data "whisparr_media_management" "example" {
}
```
